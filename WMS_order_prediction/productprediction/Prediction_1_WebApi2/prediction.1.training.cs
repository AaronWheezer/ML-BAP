    ...
    public partial class Prediction_1
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Date",outputColumnName:@"Date")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=10,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"Orders",FeatureColumnName=@"Features"}));
