...
using Microsoft.ML;
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\aaron\Desktop\thesis\toywarehouse\warehouse_orders.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:11,seriesLength:30,trainSize:6000,horizon:10,outputColumnName:@"Orders",inputColumnName:@"Orders",confidenceLowerBoundColumn:@"Orders_LB",confidenceUpperBoundColumn:@"Orders_UB");
